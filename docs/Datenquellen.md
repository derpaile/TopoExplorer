...
- Landbedeckung 2015: DLR/EOC, „Land Cover DE – Sentinel-2 – Germany, 2015“, DOI `10.15489/1ccmlap3mn39`, CC BY-NC 4.0.
- Landbedeckung 2020: mundialis / Projekt incora, „Landcover classification map of Germany 2020 based on Sentinel-2 data“, Datenlizenz Deutschland – Namensnennung – Version 2.0 (`DL-DE/BY-2.0`). Die Klassenlegende lautet Wald, niedrige Vegetation, Wasser, Bebauung, offener Boden und Landwirtschaft.
...
- https://data.gov.de/suche/daten/landcover-classification-map-of-germany-2020-based-on-sentinel-2-data
